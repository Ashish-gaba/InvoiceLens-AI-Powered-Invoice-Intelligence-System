...
st.set_page_config(
    page_title="InvoiceLens — AI-Powered Freight Cost Prediction & Invoice Risk Analytics",
    page_icon="⬡",
    layout="wide",
...
:root {
    ...
    --sidebar-active: rgba(99,202,183,0.14);
    --border:    rgba(255,255,255,0.08);
    --border-hi: rgba(99,202,183,0.4);
    --accent:    #63CAB7;
    --accent2:   #4F86F7;
    --danger:    #FF5A5A;
    --success:   #3DFFA0;
...
[data-testid="stSidebar"] {
    background: linear-gradient(180deg, var(--sidebar) 0%, #0D1522 100%) !important;
    border-right: 1px solid var(--border) !important;
    box-shadow: 4px 0 24px rgba(0,0,0,0.25) !important;
}
[data-testid="stSidebar"] > div:first-child {
    padding: 1.75rem 1.1rem 2rem 1.1rem !important;
}
[data-testid="stSidebar"] * {
    font-family: 'DM Sans', sans-serif !important;
}
...
/* Nav item container (Streamlit baseweb radio) */
...
[data-testid="stSidebar"] .stRadio [data-baseweb="radio"][aria-checked="true"] {
    ...
    border-color: rgba(99,202,183,0.28) !important;
    box-shadow: inset 3px 0 0 var(--accent) !important;
}
[data-testid="stSidebar"] .stRadio [data-baseweb="radio"] > div:last-child,
[data-testid="stSidebar"] .stRadio [data-baseweb="radio"] > div:last-child p {
...
[data-testid="stSidebar"] .stRadio [data-baseweb="radio"]:hover > div:last-child p {
    color: #F0F4FA !important;
}
[data-testid="stSidebar"] .stRadio [data-baseweb="radio"][aria-checked="true"] > div:last-child,
[data-testid="stSidebar"] .stRadio [data-baseweb="radio"][aria-checked="true"] > div:last-child p {
    color: #FFFFFF !important;
    font-weight: 600 !important;
}

/* Nav radio labels (fallback for label-based markup) */
...
with st.sidebar:
    ...
    <div class="sidebar-brand">
        <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="17" y="22" text-anchor="middle"
                  ...
                  font-size="11" fill="#080C14">IL</text>
        </svg>
        <div class="brand-name">Invoice<span>Lens</span></div>
    </div>
    """, unsafe_allow_html=True)
    ...
    NAV_ITEMS = {
        "Dashboard": "◎  Dashboard",
        "Freight Prediction": "▸  Freight Prediction",
        "Invoice Risk Detection": "◈  Invoice Risk Detection",
    }
    page = st.radio(
        "",
        list(NAV_ITEMS.keys()),
    ...
    <div class="sidebar-footer">
        <span class="sidebar-footer-title">InvoiceLens v2.0</span>
        AI-Powered Freight Cost &amp; Invoice Risk Analytics.
        <span class="sidebar-footer-status">Models loaded · Ready</span>
    </div>
    """, unsafe_allow_html=True)
...
if page == "Dashboard":
    ...
    st.markdown('<p class="page-sub">InvoiceLens — AI-Powered Freight Cost &amp; Invoice Risk Analytics.</p>', unsafe_allow_html=True)
